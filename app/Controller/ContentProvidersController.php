...
class ContentProvidersController extends AppController {

        public $uses = array('ContentProvider', 'ServiceProvider');
        ...
        public function index() {
                ...
                $breadcrumb[] = array(
                    ...
                    'label' => __('content_provider_title'),
                );
                $this->set('breadcrumb', $breadcrumb);
                $this->set('page_title', __('content_provider_title'));
        ...
        protected function setSearchConds(&$options) {
                ...
                if (isset($this->request->query['service_provider_code']) && strlen(trim($this->request->query['service_provider_code'])) > 0) {
                        $serviceProviderCode = trim($this->request->query['service_provider_code']);
                        $this->request->query['service_provider_code'] = $serviceProviderCode;
                        $options['conditions']['service_provider_code']['$regex'] = new MongoRegex("/" . mb_strtolower($serviceProviderCode) . "/i");
                }
        ...
        public function beforeFilter() {
                ...
                //$this->Auth->allow();
                $this->set('serviceProviderList', $this->ServiceProvider->findListNameCode());
        }
