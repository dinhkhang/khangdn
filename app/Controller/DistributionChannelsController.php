...
class DistributionChannelsController extends AppController {

        public $uses = array('DistributionChannel', 'Distributor');
        ...
        public function index() {
                ...
                $breadcrumb[] = array(
                    ...
                    'label' => __('distribution_channel_title'),
                );
                $this->set('breadcrumb', $breadcrumb);
                $this->set('page_title', __('distribution_channel_title'));
        ...
        protected function setSearchConds(&$options) {
                ...
                if (isset($this->request->query['service_provider_code']) && strlen($this->request->query['service_provider_code']) > 0) {
        ...
        public function beforeFilter() {
                ...
                //$this->Auth->allow();
                $this->set('distributorList', $this->Distributor->findListNameCode());
        }
