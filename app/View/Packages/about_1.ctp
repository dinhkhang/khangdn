            ...
            <div class="rows">
                <div class="intabs">
                    ...
                    <p>
                        ...
                        - Thời gian sử dụng: <strong><?php echo implode(', ', $time_register); ?></strong><br>
                        - Để hủy gói cước <a href="<?php echo Router::url(array('controller' => 'Rules', 'action' => 'index')) ?>">tại đây</a>, gói cước của bạn sẽ là gói cước mặc định
                    </p>
