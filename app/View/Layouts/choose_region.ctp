...
<html lang="en">
    <head>
        ...
        <link href="<?php echo Router::url('/') ?>css/assets/css/bootstrap-select.min.css" rel="stylesheet">
        ...
        <script src="<?php echo Router::url('/') ?>css/assets/js/bootstrap-select.js"></script>
