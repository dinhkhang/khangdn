                ...
                <div class="ibox float-e-margins">
                        <div class="ibox-content">
                                ...
                                <div class="form-group">
                                        <label class="col-sm-2 control-label"><?php echo __('distributor_service_provider_code') ?> <?php echo $this->element('required') ?></label>
                                        <div class="col-sm-10">
                                                <?php
                                ...
                                ?>
                                <div class="form-group <?php echo $name_err_class ?>">
                                        <label class="col-sm-2 control-label"><?php echo __('distributor_sologan') ?> <?php echo $this->element('required') ?></label>
                                ...
                                ?>
                                <div class="form-group <?php echo $name_err_class ?>">
                                        <label class="col-sm-2 control-label"><?php echo __('distributor_private_key') ?> <?php echo $this->element('required') ?></label>
                                ...
                                ?>
                                <div class="form-group <?php echo $name_err_class ?>">
                                        <label class="col-sm-2 control-label"><?php echo __('distributor_server_ip') ?> <?php echo $this->element('required') ?></label>
                                ...
                                ?>
                                <div class="form-group <?php echo $name_err_class ?>">
                                        <label class="col-sm-2 control-label"><?php echo __('distributor_mobile') ?> <?php echo $this->element('required') ?></label>
                                ...
                                ?>
                                <div class="form-group <?php echo $name_err_class ?>">
                                        <label class="col-sm-2 control-label"><?php echo __('distributor_email') ?> <?php echo $this->element('required') ?></label>
                                ...
                                <div class="form-group <?php echo $dial_code_err_class ?>">
                                        <label class="col-sm-2 control-label"><?php echo __('distributor_website') ?> <?php echo $this->element('required') ?></label>
                                ...
                                ?>
                                <div class="form-group <?php echo $dial_code_err_class ?>">
                                        <label class="col-sm-2 control-label"><?php echo __('distributor_wap_domain') ?> <?php echo $this->element('required') ?></label>
                                ...
                                <div class="form-group <?php echo $code_err_class ?>">
                                        <label class="col-sm-2 control-label"><?php echo __('distributor_description') ?> <?php echo $this->element('required') ?></label>
