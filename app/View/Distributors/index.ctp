                ...
                <div class="col-md-4">
                        <div class="form-group">
                                ...
                                echo $this->Form->input('service_provider_code', array(
                                    'div' => false,
                                    'class' => 'form-control',
                                    'label' => __('distributor_service_provider_code'),
                                ...
                                <thead>
                                        <tr>
                                                <?php if (!empty($list_data)): ?>
                                                        ...
                                                        <th><?php echo $this->Paginator->sort('service_provider_code', __('distributor_service_provider_code')); ?></th>
                                                        <th><?php echo $this->Paginator->sort('code', __('distributor_code')); ?></th>
                                                        <th><?php echo $this->Paginator->sort('name', __('distributor_name')); ?></th>
                                                        <th><?php echo $this->Paginator->sort('wap_domain', __('distributor_wap_domain')); ?></th>
                                                        <th><?php echo $this->Paginator->sort('website', __('distributor_website')); ?></th>
                                                        <th><?php echo $this->Paginator->sort('sologan', __('distributor_sologan')); ?></th>
                                                        <th><?php echo $this->Paginator->sort('email', __('distributor_email')); ?></th>
                                                        <th><?php echo $this->Paginator->sort('mobile', __('distributor_mobile')); ?></th>
                                                        <th><?php echo $this->Paginator->sort('server_ip', __('distributor_server_ip')); ?></th>
                                                        <th><?php echo $this->Paginator->sort('private_key', __('distributor_private_key')); ?></th>
                                                ...
                                                <?php else: ?>
                                                        <th><?php echo __('no') ?></th>
                                                        <th><?php echo __('distributor_service_provider_code'); ?></th>
                                                        <th><?php echo __('distributor_code'); ?></th>
                                                        <th><?php echo __('distributor_name'); ?></th>
                                                        <th><?php echo __('distributor_wap_domain'); ?></th>
                                                        <th><?php echo __('distributor_website'); ?></th>
                                                        <th><?php echo __('distributor_sologan'); ?></th>
                                                        <th><?php echo __('distributor_email'); ?></th>
                                                        <th><?php echo __('distributor_mobile'); ?></th>
                                                        <th><?php echo __('distributor_server_ip'); ?></th>
                                                        <th><?php echo __('distributor_private_key'); ?></th>
