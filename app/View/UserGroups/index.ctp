			...
			<table class="table table-striped">
				<thead>
					<tr>
						...
						<th><?php echo __('user_group_description') ?></th>
						<th><?php echo __('user_group_status') ?></th>
...
<!--									<a href="<?php echo Router::url(array('action' => 'reqDelete', $id)) ?>" class="btn btn-danger remove" title="<?php echo __('delete_btn') ?>">
					...
					<?php else: ?>
						<tr>
							<td colspan="5" style="text-align: center"><?php echo __('no_result') ?></td>
						</tr>
					<?php endif; ?>
				</tbody>
			</table>
