        ...
        <div class="col-lg-12">
                <div class="ibox float-e-margins">
                        <div class="ibox-content">
                                ...
                                ?>
                                <?php
                                $code_err = $this->Form->error($model_name . '.platform_provider_code');
                                $code_err_class = !empty($code_err) ? 'has-error' : '';
                                ?>
                                <div class="form-group">
                                        <label class="col-sm-2 control-label"><?php echo __('service_provider_platform_provider_code') ?></label>
                                        <div class="col-sm-10">
                                                <?php
                                                echo $this->Form->input($model_name . '.platform_provider_code', array(
                                                    'class' => 'form-control',
                                                    'div' => false,
                                                    'label' => false,
                                                    'default' => '',
                                ...
                                <div class="form-group <?php echo $name_err_class ?>">
                                        <label class="col-sm-2 control-label"><?php echo __('service_provider_name') ?> <?php echo $this->element('required') ?></label>
                                ...
                                ?>
                                <div class="form-group <?php echo $name_err_class ?>">
                                        <label class="col-sm-2 control-label"><?php echo __('service_provider_code') ?> <?php echo $this->element('required') ?></label>
                                ...
                                ?>
                                <div class="form-group <?php echo $name_err_class ?>">
                                        <label class="col-sm-2 control-label"><?php echo __('service_provider_sologan') ?> <?php echo $this->element('required') ?></label>
                                ...
                                ?>
                                <div class="form-group <?php echo $name_err_class ?>">
                                        <label class="col-sm-2 control-label"><?php echo __('service_provider_private_key') ?> <?php echo $this->element('required') ?></label>
                                ...
                                ?>
                                <div class="form-group <?php echo $name_err_class ?>">
                                        <label class="col-sm-2 control-label"><?php echo __('service_provider_server_ip') ?> <?php echo $this->element('required') ?></label>
                                ...
                                ?>
                                <div class="form-group <?php echo $name_err_class ?>">
                                        <label class="col-sm-2 control-label"><?php echo __('service_provider_mobile') ?> <?php echo $this->element('required') ?></label>
                                ...
                                ?>
                                <div class="form-group <?php echo $name_err_class ?>">
                                        <label class="col-sm-2 control-label"><?php echo __('service_provider_email') ?> <?php echo $this->element('required') ?></label>
                                ...
                                <div class="form-group <?php echo $dial_code_err_class ?>">
                                        <label class="col-sm-2 control-label"><?php echo __('service_provider_website') ?> <?php echo $this->element('required') ?></label>
                                ...
                                <div class="hr-line-dashed"></div>
                                <?php
                                $dial_code_err = $this->Form->error($model_name . '.cms_domain');
                                $dial_code_err_class = !empty($dial_code_err) ? 'has-error' : '';
                                ?>
                                <div class="form-group <?php echo $dial_code_err_class ?>">
                                        <label class="col-sm-2 control-label"><?php echo __('service_provider_cms_domain') ?> <?php echo $this->element('required') ?></label>

                                        <div class="col-sm-10">
                                                <?php
                                                echo $this->Form->input($model_name . '.cms_domain', array(
                                                    'type' => 'url',
                                                    'class' => 'form-control',
                                                    'div' => false,
                                                    'label' => false,
                                ...
                                <div class="form-group <?php echo $code_err_class ?>">
                                        <label class="col-sm-2 control-label"><?php echo __('service_provider_description') ?> <?php echo $this->element('required') ?></label>
...
//                                                    'required' => true,
                                ...
                                if ($user['type'] !== 'CONTENT_PROVIDER'):
                                        ?>
                                        <div class="form-group">
                                                <label class="col-sm-2 control-label"><?php echo __('service_provider_status') ?></label>
