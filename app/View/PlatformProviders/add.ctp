                ...
                <div class="ibox float-e-margins">
                        <div class="ibox-content">
                                ...
                                <div class="form-group <?php echo $name_err_class ?>">
                                        <label class="col-sm-2 control-label"><?php echo __('platform_provider_name') ?> <?php echo $this->element('required') ?></label>
                                ...
                                ?>
                                <div class="form-group <?php echo $name_err_class ?>">
                                        <label class="col-sm-2 control-label"><?php echo __('platform_provider_code') ?> <?php echo $this->element('required') ?></label>
                                ...
                                ?>
                                <div class="form-group <?php echo $name_err_class ?>">
                                        <label class="col-sm-2 control-label"><?php echo __('platform_provider_email') ?> <?php echo $this->element('required') ?></label>
                                ...
                                ?>
                                <div class="form-group <?php echo $name_err_class ?>">
                                        <label class="col-sm-2 control-label"><?php echo __('platform_provider_mobile') ?> <?php echo $this->element('required') ?></label>
                                ...
                                ?>
                                <div class="form-group <?php echo $name_err_class ?>">
                                        <label class="col-sm-2 control-label"><?php echo __('platform_provider_website') ?> <?php echo $this->element('required') ?></label>
                                ...
                                ?>
                                <div class="form-group <?php echo $name_err_class ?>">
                                        <label class="col-sm-2 control-label"><?php echo __('platform_provider_order') ?></label>
                                ...
                                <div class="form-group <?php echo $code_err_class ?>">
                                        <label class="col-sm-2 control-label"><?php echo __('platform_provider_description') ?> <?php echo $this->element('required') ?></label>
...
//                                                    'required' => true,
                                ...
                                if ($user['type'] !== 'CONTENT_PROVIDER'):
                                        ...
                                        <div class="form-group">
                                                <label class="col-sm-2 control-label"><?php echo __('platform_provider_status') ?></label>
